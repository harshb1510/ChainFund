...
const Hero = () => {
  ...
  >
    <h2 className=" mb-16 text-[70px] font-bold leading-10 tracking-widest  text-left flex justify-between items-center ">
     Finance and<br/><br/>Crowdfunding on<br/><br/> Blockchain
    <img src="https://cryptologos.cc/logos/ethereum-eth-logo.png?v=029" alt="" className='w-[400px] h-[400px] z-20 hover:' />
    </h2>
    <div className="columns-1">
      <div className="w-full max-w-[600px] pl-0 float-left min-h-[1px] pr-[10px] relative">
        <div className="flex max-w-full gap-x-4 gap-y-4 mb-0 pl-1 pr-3">
          ...
          <Link
            to="show-campaigns"
            className="w-[152px] bg-white  text-black text-center tracking-tight rounded-lg pt-4 pr-4 pb-4 pl-3 font-semibold text-[20px] inline-block "
          >
            Fund
          </Link>
        </div>
